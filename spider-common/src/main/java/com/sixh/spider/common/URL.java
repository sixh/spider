...
import com.sixh.spider.common.utils.CollectionUtils;
 ...
 * </ul>
 *
 * reference：https://github.com/apache/incubator-dubbo/blob/master/dubbo-common/src/main/java/org/apache/dubbo/common/URL.java
 * @see java.net.URL
 * @see java.net.URI
 */
public final class URL implements Serializable {
    ...
    public String getBackupAddress(int defaultPort) {
        ...
        String[] backups = getParameter(Const.BACKUP_KEY, new String[0]);
    ...
    public String getParameter(String key) {
        ...
        if (value == null || value.length() == 0) {
            value = parameters.get(Const.DEFAULT_KEY_PREFIX + key);
        }
        return value;
    }
    ...
    public String[] getParameter(String key, String[] defaultValue) {
        ...
        return Const.COMMA_SPLIT_PATTERN.split(value);
    }
